...
/**
 * У нас нет необходимости создавать отдельно Адреса
 */

// по заданию контроллер создан)

/**
 package com.example.demospingboot_snsz.web;
 
 import com.example.demospingboot_snsz.domain.Address;
 import com.example.demospingboot_snsz.domain.AddressRepository;
